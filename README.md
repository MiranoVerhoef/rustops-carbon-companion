...
Current version: **0.8.2** · Protocol: **v1**
...
Premium source-file management is constrained to top-level `.cs` files inside `carbon/plugins`, capped at 512 KiB. Replacements and deletions create server-local backups; retention follows the organization's RustOps plan.
